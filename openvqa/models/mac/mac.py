...
class MACUnit(nn.Module):
    def __init__(self,__C):
        ...
        self.control = ControlUnit(__C.HIDDEN_SIZE, __C.MAX_STEP)
        self.read = ReadUnit(__C.HIDDEN_SIZE)
        self.write = WriteUnit(__C.HIDDEN_SIZE, __C.SELF_ATTENTION, __C.MEMORY_GATE)

        self.mem_0 = nn.Parameter(torch.zeros(1, __C.HIDDEN_SIZE))
        self.control_0 = nn.Parameter(torch.zeros(1, __C.HIDDEN_SIZE))

        self.dim = __C.HIDDEN_SIZE
        self.max_step = __C.MAX_STEP
